                        ...
                        <div className="social-info">
                            ...
                            <div className="info-icon">
                                <a href="https://www.linkedin.com/in/carlie-feno-516063240/" className="">
                                    <img className="icon" src={navIcon1} alt="" /><span >FENO Carlie</span>
                                </a>
                                
                                <a href="https://www.facebook.com/aidane.feno" className="">
                                    <img className="icon" src={navIcon2} alt="" /><span >FENO Carlie</span>
                                </a>
                                <a href="https://github.com/FenoCarlie"  className="">
                                    <img className="icon" src={navIcon3} alt="" /><span >FENO Carlie</span>
                                </a>
                            </div>
                        </div>
                    </div>
