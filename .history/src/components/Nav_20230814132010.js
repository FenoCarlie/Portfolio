    ...
    return (
        <nav className="container">
            ...
            <div className="icon">
                ...
                <a href="https://www.facebook.com/aidane.feno" target="_blank" rel="noopener noreferrer" className="sm-icon">
                    <FontAwesomeIcon icon={faSquareFacebook} />
                </a>
                <a href="https://github.com/FenoCarlie" target="_blank" rel="noopener noreferrer" className="sm-icon">
