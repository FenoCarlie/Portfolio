...
import photo from '../img&logo/Carlie.jpg';
...
const Home = () => {
    ...
    return (
        <section className="banner me" id="home">
        <div className="container">
            <div className="banner-content me">
            <div>
                <TrackVisibility>
                {({ isVisible }) =>
                ...
                <div className="svg-container">
                    ...
                    <img src={ photo } alt="Superposed" className="overlay-image" />
                </div>
            </div>
        </div>
        </section>
