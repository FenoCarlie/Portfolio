...
import { row , col } from '../../node_modules/bootstrap/dist/css/bootstrap-grid.css';
        ...
        <section className="banner" id="home">
            <div className="my_container">
                <div className="row">
                    ...
                    <div className="col">
                        <div className="back">
                            <svg xmlns="http://www.w3.org/2000/svg" className="svg" width="671" height="679" viewBox="0 0 671 679" fill="none">
