...
function NavBar() {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 lg:px-20 xl:px-48 text-white">
      <div className="">
        <Link href="/" className="">
      ...
      <div className="hidden md:flex gap-4">
        {links.map((link) => (
          <NavLink to={link.url} key={link.title} className="px-3 py-2">
            {link.title}
          </NavLink>
        ))}
      </div>
