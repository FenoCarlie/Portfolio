...
function NavBar() {
  ...
  return (
    <div className="h-full flex items-center bg-greyGlass1 justify-between px-4 sm:px-10 lg:px-20 xl:px-30 text-white">
      <div className="">
      ...
      <div className="md:hidden">
        ...
        {open && (
          <div className="relative right-0 top-0 left-0 w-screen h-screen bg-greyGlass1 text-white flex flex-col items-center justify-center gap-8 text-4xl">
            {links.map((link) => (
              <button
                key={links.title}
                onClick={() => {
