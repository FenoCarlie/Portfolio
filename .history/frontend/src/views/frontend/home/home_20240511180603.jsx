    ...
    <div id="home" className="w-full h-full">
      <div className="flex w-full flex-col h-full p-4 sm:flex-col lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        <section className="flex items-center h-[50%] lg:h-full xl:h-full sm:h-[50%] lg:w-[50%] xl:w-[50%] sm:w-full  p-4">
          <TrackVisibility>
            <div className={""}>
              <span className="text-yellowClaire flex item-end">
                <h3 className="mr-2 text-xl">-- I'm</h3>
                <h1 className="text-4xl">Carlie FENO</h1>
              </span>
              <h1>
                <p
                ...
                >
                  <span className="text-3xl border-r-2 border-grey1">
                    {text}
                  </span>
                </p>
              </h1>
              <h2 className="mlg text-grey1 ">From Madagascar</h2>
            </div>
          </TrackVisibility>
        </section>
