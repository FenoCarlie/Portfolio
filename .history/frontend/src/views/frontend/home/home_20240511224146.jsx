  ...
  return (
    <div id="home" className="w-full h-full relative">
      <div className="flex justify-between w-full h-full p-4 lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        ...
        <section className="hidden bg-grey1 p-4 lg:flex xl:flex xl:w-[50%] lg:w-[50%] lg:h-full- xl:h-full">
          <div className="w-[600px] h-[600px] absolute left-[800px] top-[200px] border-[2px] border-yellowClaire rounded-full"></div>
        </section>
