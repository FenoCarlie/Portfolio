  ...
  return (
    <div id="home" className="w-full h-full">
      <div className="flex w-full h-full p-4 lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        <section className="bg-greyGlass flex items-center h-hull w-full lg:h-full xl:h-full lg:w-[50%] xl:w-[50%] p-4">
          <TrackVisibility>
        ...
        <section className="hidden xl:flex lg:flex h-[50%] lg:h-full xl:h-full lg:w-[50%] xl:w-[50%]  p-4 ">
          section 2
        </section>
      </div>
    </div>
