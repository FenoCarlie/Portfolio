        ...
        <section className=" flex items-center h-hull w-full p-4 xl:w-[50%] lg:w-[50%]">
          <TrackVisibility className="w-full">
            ...
            <section className="flex w-full items-center mt-20 ">
              <button className="px-4 hover:h-full hover:bg-yellowClaire hover:transition-all py-2 border-4 hover:text-black border-yellowClaire rounded text-white text-2xl">
                Lets's talk
              </button>
            </section>
          </TrackVisibility>
