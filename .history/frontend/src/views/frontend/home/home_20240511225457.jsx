    ...
    <div id="home" className="w-full h-full relative">
      <div className="flex justify-between w-full h-full p-4 lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
          ...
          <TrackVisibility className="w-full">
            <div className={"w-full"}>
              <span className="text-yellowClaire flex items-end">
                ...
                <h1 className="text-4xl text-[100%]">Carlie FENO</h1>
              </span>
              <h1>
                <p
        ...
        <section className="hidden p-4 lg:flex xl:flex xl:w-[50%] lg:w-[50%] lg:h-full- xl:h-full">
          <div className="w-[550px] opacity-50 h-[550px] absolute left-[40%] top-[35%] origin-top-right border-[2px] border-yellowClaire rounded-full"></div>
        </section>
