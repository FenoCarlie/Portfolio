...
function Home() {
  ...
  return (
    <div id="home" className="w-full h-full">
      <div className="flex w-full h-full p-4 lg:flex-row sm:flex-col xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        <section className="bg-greyGlass flex items-center h-hull w-full p-4 sm:h-[70%] xl:w-[50%] lg:w-[50%]">
          <TrackVisibility className="w-full">
            ...
            <section className="bg-grey1 flex w-full items-center justify-center mt-20">
              <button>Contact</button>
            </section>
          </TrackVisibility>
        </section>
        <section className=" p-4 bg-white text-black sm:h-[30%] lg:flex xl:flex xl:w-[50%] lg:w-[50%] lg:h-full- xl:h-full">
          section 2
        </section>
      </div>
    </div>
