  ...
  return (
    <div id="home" className="w-full h-full">
      <div className="flex w-full flex-col h-full p-4 sm:flex-col lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        <section className="bg-grey1 flex items-center h-[50%] lg:h-full xl:h-full sm:h-full lg:w-[50%] xl:w-[50%] sm:w-full  p-4">
          <TrackVisibility>
            <div className={""}>
        ...
        <section className="hidden xl:flex lg:flex h-[50%] lg:h-full xl:h-full sm:hidden lg:w-[50%] xl:w-[50%] sm:w-full  p-4 bg-greyGlass">
          section 2
        </section>
      </div>
    </div>
