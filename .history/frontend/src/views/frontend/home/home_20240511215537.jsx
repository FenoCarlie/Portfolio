      ...
      <div className="flex justify-between w-full h-full p-4 lg:flex-row xl:flex-row sm:px-10 lg:px-20 xl:px-30">
        ...
        <section className="hidden items-center p-4 lg:flex xl:flex xl:w-[50%] lg:w-[50%] lg:h-full- xl:h-full">
          <section className="h-full w-full flex items-center justify-center ">
            <div className=" flex item-center justify-center border-[2px] border-yellowClaire w-[450px] h-[450px]  rounded-full">
              <div className="border-[2px] border-yellowClaire w-[450px] h-[450px] mt-20 rounded-full"></div>
            </div>
          </section>
        </section>
