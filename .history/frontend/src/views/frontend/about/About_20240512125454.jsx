    ...
    <div id="about" className="w-full h-auto">
      <div className="flex flex-col p-4 sm:px-10 lg:px-20 xl:px-30">
        ...
        <div className="flex flex-col lg:flex-row xl:flex-row w-full h-auto">
          ...
          <section className="flex items-center justify-center sm:h-[50vh] lg:ml-5 xl:ml-5 w-full">
            <div className="bg-greyGlass w-[85%] h-[80%] rounded p-7 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
