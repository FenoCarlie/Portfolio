    ...
    <div id="about" className="w-full h-auto">
      <div className="flex flex-col p-4 sm:px-10 lg:px-20 xl:px-30">
        ...
        <div className="h-full w-full shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-greyGlass mt-4 p-4 rounded">
          ...
          <div className="relative w-full flex flex-col [&>label:nth-child(odd)]:left-[50%]">
            <div className="absolute left-[50%] bg-yellowClaire h-full w-[2px]"></div>
            {background.map((background) => (
              <label
                key={background.titled}
                className="flex flex-col mb-3 w-[50%]"
              >
