  ...
  return (
    <div id="about" className="w-full h-auto">
      <div className="flex flex-col p-4 sm:px-10 lg:px-20 xl:px-30">
        ...
        <div className="h-full w-full  mt-4 p-4 rounded">
          ...
          <div className="relative w-full flex flex-col bg-greyGlass traced_path">
            ...
            {background.map((background) => (
              ...
              >
                <div className="w-[95%] md:w-[75%]">
                  <h1 className="mb-2">{background.titled}</h1>
                  <h2 className="mb-3">
                    {background.time.start}
                    {" - "}
                    {background.time.end}
                  </h2>
                  <p className="ml-5 text-white">{background.description}</p>
                </div>
              </label>
            ))}
          </div>
