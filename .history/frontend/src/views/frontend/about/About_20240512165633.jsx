              ...
              <div className="flex h-full w-full justify-between flex-col">
                ...
                <section className="h-full w-full overflow-auto text-white py-4">
                  <p className="indent-8">
                    ...
                    comes to coding or cooking, my passion takes over. In a
                    constantly evolving digital world, I find my balance in
                    exploring the pleasures of cooking and passionately
                    following the latest technological advancements. I find
                    beauty in the logic and creativity of programming, while
                    savoring each dish prepared with love.
                  </p>
                </section>
                <div className="bg-yellowClaire w-full h-1"></div>
              </div>
