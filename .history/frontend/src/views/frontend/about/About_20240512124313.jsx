    ...
    <div id="about" className="w-full h-auto">
      <div className="flex flex-col p-4 sm:px-10 lg:px-20 xl:px-30">
        <section className="flex flex-col w-full">
          <h1 className="text-3xl text-white mb-10">About me</h1>
          <div className="flex flex-col bg-black h-[15px] w-full justify-between py-3">
            <div className="bg-yellowClaire w-[40%] h-[2px]"></div>
            <div className="bg-yellowClaire w-[40%] h-[2px]"></div>
          </div>
        </section>
