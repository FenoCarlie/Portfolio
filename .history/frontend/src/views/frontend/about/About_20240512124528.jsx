    ...
    <div id="about" className="w-full h-auto">
      <div className="flex flex-col p-4 sm:px-10 lg:px-20 xl:px-30">
        <section className="flex flex-col w-full">
          ...
          <div className="flex flex-col mb-10 h-[15px] w-full justify-between">
            <div className="bg-yellowClaire w-[50%] h-[1px]"></div>
            <div className="bg-yellowClaire w-[40%] h-[1px]"></div>
          </div>
        </section>
