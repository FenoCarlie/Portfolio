              ...
              <div className="flex h-full w-full justify-between flex-col">
                ...
                <section className="h-full w-full overflow-auto text-white py-4">
                  <p className="indent-8">
                    ...
                    <br /> Shy with strangers, yet I find my voice when
                    discussing my passions. Deeply devoted and protective
                    towards my loved ones, I always strive to create a positive
                    environment around me. Pressure can sometimes disrupt my
                    concentration, but my love for cooking and mechanical sports
                    allows me to find refuge and inspiration. Always eager to
                    discover new recipes and keep up with the latest technology
                    news, I navigate with curiosity in these two worlds. In a
                    perpetual quest for knowledge, I am a passionate computer
                    science student, always ready to learn and share. My friends
                    know me as someone reserved, but as soon as it comes to
                    coding or cooking, my passion takes over. In a constantly
