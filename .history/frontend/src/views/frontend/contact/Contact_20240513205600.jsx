      ...
      <div className="px-4 mb-4 flex flex-col items-center justify-center sm:px-10 lg:px-20 xl:px-30">
        ...
        <section className="h-full w-full md:w-[90%] mt-4 rounded">
          <section className="w-full h-full flex flex-row justify-between">
            <div></div>
            <div className="bg-greyGlass flex flex-col p-3 rounded w-[70vh] h-[75vh]">
              <TabPan>
                <TabContent
                  className="w-full h-full flex flex-col"
                  label="Individual"
                >
                  <form className="item-center justify-center w-full h-full flex-col flex ">
                    <span className="flex w-full flex-row px-10 mb-3">
                      <div className="w-full flex flex-col md:flex-row justify-between">
                        <span className="flex flex-col md:w-[27vh]">
                    ...
                    <span className="flex w-full flex-row px-10 mg-3">
                    ...
                    <span className="flex w-full flex-row px-10">
                      <span className="flex flex-col w-full">
                        <label>First name</label>
                        <textarea className="max-h-80 h-48"></textarea>
                      </span>
                    </span>
                  </form>
                </TabContent>
